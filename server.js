...
// Specific route for /product to serve product.html (for clarity)
app.get('/product', (req, res) => {
  res.sendFile(path.join(__dirname, 'product.html'));
});

// Specific route for catalog etc if they are in subdirs
app.get('/_5/code', (req, res) => {
  res.sendFile(path.join(__dirname, '_5', 'code.html'));
});
